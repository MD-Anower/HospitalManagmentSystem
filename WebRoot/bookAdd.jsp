...
<html>
  <head>
    ...
    <title>My JSP 'DoctorAdd.jsp' starting page</title>
  ...
  <nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item active" aria-current="page">Add Doctor Category</li>
	  </ol>
	</nav>
    <div class="container">
    <h2>This is add Doctor Add page.</h2> <br>
    <form  method="post" action="bookAction_add" enctype="multipart/form-data">  
    	<div class="form-group">
		    <label for="BookName">Doctor Name</label>
